---
layout: post
title: Design spectrometer v 02
...
xmlFN = '/Users/thomasgumbricht/docs-local/blender-py-params/spectrodim_2019_v02.xml'
...
for square in squares:
    ...
    for sqh in squareholes:
        ...
        if rx == ry == 0:
            ...
            dy = boxWallT
            dz = sy
            position = (position[0]+fy, boxL-(boxWallT/2), position[2]+fx)
        ...
        bpy.ops.transform.resize(value=(dx/2, dy/2, dz))
    ...
    for sqh in roundholes:
        ...
        bpy.ops.mesh.primitive_cylinder_add( radius=sx, depth = boxWallT*2, location=position, rotation=rotation)
        #Rotate as a postprocess
        del_ob = bpy.context.object
        if rx != 0:
            bpy.ops.transform.rotate(value=radians(rx), constraint_axis=(True, False, False))
...
FP = "/Users/thomasgumbricht/docs-local/STL_models/2019/test_v3.ply"
